...
import io.github.nexllm.gateway.repository.VirtualModelRepository;
...
public class PostgresVirtualModelRepository implements VirtualModelRepository {
    ...
    public Mono<List<ProviderModelEntity>> findModelsByVirtualModelId(UUID tenantId, UUID virtualModelId) {
        String sql = """
        ...
        return databaseClient.sql(sql)
            ...
            .mapProperties(ProviderModelEntity.class)
            .all()
            .collectList()
            ;
    }
